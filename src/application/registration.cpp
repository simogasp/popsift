...
#include <popsift/reg_features.h>
...
int main(int argc, char **argv)
{
    ...
    popsift::RegFeatures* lFeatures = dynamic_cast<popsift::RegFeatures*>( lJob->get() );
    cout << "Number of features:    " << lFeatures->getFeatureCount() << endl;
    cout << "Number of descriptors: " << lFeatures->getDescriptorCount() << endl;

    popsift::RegFeatures* rFeatures = dynamic_cast<popsift::RegFeatures*>( rJob->get() );
